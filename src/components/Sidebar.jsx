          ...
          <ul className="space-y-2 px-4">
            ...
            <li>
              <button
                ...
                className="flex items-center gap-4 px-4 py-3 rounded-lg w-full text-left font-heading transition-colors duration-200 text-gray-700 dark:text-gray-300 hover:bg-gray-100 dark:hover:bg-gray-700"
              >
